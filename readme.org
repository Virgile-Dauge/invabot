...
- *Arme secondaire* :: Bâton de feu/vie /(recommandés)/
...
- *Arme principale* :: Lance avec [[https://nwdb.info/db/perk/perkid_weapon_dmgcorrupted][Corrupted Bane]] (obligatoire) et [[https://nwdb.info/db/perk/perkid_weapon_empoweroncrit][Keenly Empowered]] ou [[https://nwdb.info/db/perk/perkid_weaponmelee_dmgback][Rogue]] (recommandés). [[https://nwdb.info/build?skills=10-l71p4w-tsmm2s][Build lance]] (obligatoire)
...
- *Armure* :: Légère avec perks [[https://nwdb.info/db/perk/perkid_ability_spear_javelin][Sundering Javelin]] (obligatoire)
  [[https://nwdb.info/db/perk/perkid_ability_spear_skewer][Enfeebling Skewer]] (obligatoire) [[https://nwdb.info/db/perk/perkid_ability_spear_perforate][Fortifying Perforate]] (recommandés)
...
- *Arme principale* :: Bâton de vie /(obligatoire)/ avec [[https://nwdb.info/db/perk/perkid_weaponlife_healoutgoing][Blessed]]
  /(recommandé)/
- *Arme secondaire* :: Hache double avec [[https://nwdb.info/db/perk/perkid_weapon_dmgcorrupted][Corrupted Bane]] et [[https://nwdb.info/db/item/ambercutt4][Pristine Amber]] /(obligatoire)/
- *Armure* :: Lourde avec ?
...
*** Mousquet
https://nwdb.info/build?skills=6-nm5xz8-qtbfi8_10-l71p4w-tsmm2s
* Concept :
...
#+begin_src python :tangle algo.py
  ...
  def get_roster():
      ...
      return pd.read_csv(url).iloc[1:, 0:9].dropna().set_index('dtag')
  print(get_roster())
#+end_src
